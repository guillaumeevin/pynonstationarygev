...
from extreme_data.meteo_france_data.scm_models_data.crocus.crocus import CrocusDepth, CrocusRamsond
...
def write_one_sheet_name(writer, massif_name, altitude):
    ...
    for orientation in ORIENTATIONS[:]:
        ...
        for study_class, name in [(CrocusDepth, 'Depth'), (CrocusRamsond, 'Ramsond')]:
