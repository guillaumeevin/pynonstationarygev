...
def run_mas(altitude, altitudes, display_only_model_that_pass_gof_test, fast, gcm_rcm_couples, massif_names,
    ...
    for massif_name in all_massif_names[::-1]:
        print(massif_name)
        ...
        nb_train = 61
        ratio_train_test = 2
        nb_test = int(round(nb_train / ratio_train_test))
        year_max = 2020 + nb_test - 1
        print('ratio, and year max')
        print(ratio_train_test, year_max)

        study = 'snowfall' if snowfall else 'snow_load'
        csv_filename = 'last_{}_fast_{}_altitudes_{}_nb_of_models_{}_nb_gcm_rcm_couples_{}_alpha_{}_ratio_{}.xlsx'.format(study,
                                                                                                                 fast,
                                                                                                                 altitude,
                                                                                                                 len(model_classes),
