...
def main_model_as_truth_experiment():
    ...
    study_class, temporal_covariate_for_fit, remove_physically_implausible_models, display_only_model_that_pass_gof_test = set_up_and_load(fast)
    ...
    for i, combination_name in enumerate(combination_names_for_loop, 1):
        ...
        average = compute_average_nllh(altitudes_list, param_name_to_climate_coordinates_with_effects, gcm_rcm_couples,
                                       ...
                                       remove_physically_implausible_models, display_only_model_that_pass_gof_test)
