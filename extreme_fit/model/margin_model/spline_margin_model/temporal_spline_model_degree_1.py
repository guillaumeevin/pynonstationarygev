...
class NonStationaryThreeLinearLocationAndScaleOneLinearShapeModel(SplineMarginModel):
...
class NonStationaryFourLinearLocationAndScaleOneLinearShapeModel(SplineMarginModel):
